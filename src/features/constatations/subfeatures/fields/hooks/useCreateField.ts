...
export const useCreateField = ({
  ...
  return useMutation({
    onSuccess: async (data) => {
      ...
      let index = previousFieldGroups.findIndex(
        (obj) => obj.id.toString() == fieldGroupId
      );
      ...
      let constatIndex2 = previousConstatations[
        constatIndex
      ].field_groups.findIndex((obj) => obj.id.toString() == fieldGroupId);
      previousConstatations[constatIndex].field_groups[
        constatIndex2
      ].fields.push(data);
